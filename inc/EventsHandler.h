...
class EventsHandler
{
	public:
		enum event{
			NONE, TRANSFER_COMPLETE, LOGIN_RESULT, USERS_UPDATED, NODE_UPDATED, NODE_REMOVED, UNLINK_RESULT, UPLOAD_COMPLETE, PUTNODES_RESULT, TRANSFER_UPDATE, TOPEN_RESULT
		};
